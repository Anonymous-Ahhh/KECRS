...
from .modules import DKCRS


class DkcrsAgent(TorchAgent):
    @classmethod
    def add_cmdline_args(cls, argparser):
        """Add command-line arguments specifically for this agent."""
        super(DkcrsAgent, cls).add_cmdline_args(argparser)
        ...
        DkcrsAgent.dictionary_class().add_cmdline_args(argparser)
        return agent
